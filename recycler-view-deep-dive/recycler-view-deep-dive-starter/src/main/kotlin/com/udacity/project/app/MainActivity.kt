...
class MainActivity : AppCompatActivity() {
    ...
    private fun observeViewModel() {
         ...
         *
         * After converting TaskAdapter to ListAdapter in Part 1:
         * - Replace taskAdapter.updateTasks(tasks) with taskAdapter.submitList(tasks)
         * - This triggers DiffUtil calculation and automatic animations
         */
