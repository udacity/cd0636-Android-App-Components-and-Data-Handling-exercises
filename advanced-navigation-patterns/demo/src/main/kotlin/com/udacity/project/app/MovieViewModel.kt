...
class MovieViewModel(private val savedStateHandle: SavedStateHandle) : ViewModel() {
    ...
    private val defaultMovies = listOf(
        Movie(id = 1, title = "The Shawshank Redemption", watched = false, isFavorite = true),
        Movie(id = 2, title = "The Dark Knight", watched = true, isFavorite = false),
        Movie(id = 3, title = "Inception", watched = false, isFavorite = true)
    )
