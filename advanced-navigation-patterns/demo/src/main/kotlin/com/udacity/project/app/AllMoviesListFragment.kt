...
class AllMoviesListFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        movieAdapter = MovieAdapter(
            onMovieClicked = { movie ->
                val action = AllMoviesListFragmentDirections.actionListToDetail(movie.id)
    ...
    private fun setupClickListeners() {
        addMovieFab.setOnClickListener {
            val action = AllMoviesListFragmentDirections.actionListToAddMovie()
            findNavController().navigate(action)
        }
    }
