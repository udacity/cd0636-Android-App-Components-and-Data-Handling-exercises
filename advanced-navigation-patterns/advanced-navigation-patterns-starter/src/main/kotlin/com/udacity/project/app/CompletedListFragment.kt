...
class CompletedListFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        // TODO 5.6: Set up TaskAdapter with navigation to detail screen
        // Use Safe Args: CompletedListFragmentDirections.actionCompletedToDetail(task.id)
    ...
    private fun setupClickListeners() {
        // TODO 5.3: Set up FAB click listener to navigate to AddTaskFragment
        // Use Safe Args: CompletedListFragmentDirections.actionCompletedToAddTask()
    ...
    private fun observeViewModel() {
        // TODO 5.4: Observe tasks and filter to show only completed
        // Filter tasks where completed == true
