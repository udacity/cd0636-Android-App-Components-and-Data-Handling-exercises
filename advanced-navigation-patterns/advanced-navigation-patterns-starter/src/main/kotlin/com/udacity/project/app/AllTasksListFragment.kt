...
class AllTasksListFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        // TODO 4.2: Set up TaskAdapter with navigation to detail screen
        // Use Safe Args: AllTasksListFragmentDirections.actionListToDetail(task.id)
    ...
    private fun setupClickListeners() {
        // TODO 4.1: Set up FAB click listener to navigate to AddTaskFragment
        // Use Safe Args: AllTasksListFragmentDirections.actionListToAddTask()
        // Navigate using findNavController().navigate(action)
