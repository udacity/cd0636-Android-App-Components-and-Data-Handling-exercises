...
class TaskDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // TODO Part 2 Step 2: Retrieve arguments using Safe Args
        // 1. Uncomment the navArgs import at the top
        // 2. Retrieve the Safe Args:
        //    val args: TaskDetailFragmentArgs by navArgs()
        //    val taskId = args.taskId
        // 3. Pass taskId to setupUI and observeTask
        // For now, using a placeholder taskId
        val taskId = 1
    ...
    private fun setupUI(taskId: Int) {
        ...
        deleteButton.setOnClickListener {
            ...
            // TODO Part 2 Step 3: Navigate back to list after deleting
            // 1. Uncomment the findNavController import at the top
            // 2. Add navigation back:
            //    findNavController().navigateUp()
            // This will pop the back stack and return to TaskListFragment
        }
    }
}